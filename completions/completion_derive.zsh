...
'-e+[Apply a procedural overlay effect to the selected wallpapers before displaying]:EFFECT:(none fractal star random)' \
'--effect=[Apply a procedural overlay effect to the selected wallpapers before displaying]:EFFECT:(none fractal star random)' \
