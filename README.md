...
It is designed to be exceptionally fast, and lightweight, performing all image stitching, cropping, scaling, and fractal generation in-process using pure Rust. 
It is compatible with both X11 and modern Wayland compositors.
